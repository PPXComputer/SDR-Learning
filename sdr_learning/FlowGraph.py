...
class FlowGraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FlowGraph")
        ...
        # Blocks
        ##################################################
        self._signal_freq_range = Range(1e3, 10e3, 1, 1e3, 200)
        self._signal_freq_win = RangeWidget(self._signal_freq_range, self.set_signal_freq, 'signal_freq', "counter_slider", float)
        self.top_grid_layout.addWidget(self._signal_freq_win)
        self._fft_size_range = Range(512, 4096, 20, 2048, 200)
        ...
        self.top_grid_layout.addWidget(self._qtgui_histogram_sink_x_1_0_win)
        ...
        self.top_grid_layout.addWidget(self._qtgui_histogram_sink_x_1_win)
        ...
        self.connect((self.blocks_char_to_float_0_0, 0), (self.qtgui_histogram_sink_x_1, 0))
        self.connect((self.blocks_char_to_float_0_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_char_to_float_0_1, 0), (self.qtgui_histogram_sink_x_1_0, 0))
        self.connect((self.blocks_char_to_float_0_1, 0), (self.qtgui_time_sink_x_1, 1))
        ...
        self.connect((self.blocks_throttle_1, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_throttle_1, 0), (self.blocks_pack_k_bits_bb_0, 0))
