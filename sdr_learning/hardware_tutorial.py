...
class hardware_tutorial(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "hardware_tutorial")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("hardware_tutorial")
        ...
        # Variables
        ##################################################
        self.tuning = tuning = 0.1021
        self.samp_rate = samp_rate = 0.00384
        self.rf_gain = rf_gain = 50

        ##################################################
        # Blocks
        ##################################################
        self._samp_rate_range = Range(0, 100, 1, 0.00384, 200)
        ...
        self._tuning_range = Range(0.07, 6e6, 200e3, 0.1021, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(0.1021, self.samp_rate)
