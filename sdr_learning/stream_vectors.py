...
class stream_vectors(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "stream_vectors")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("stream_vectors")
        ...
        self.settings = Qt.QSettings("GNU Radio", "stream_vectors")
        ...
        self.connect((self.blocks_stream_to_vector_0, 0), (self.qtgui_time_sink_x_1, 0))
...
def main(top_block_cls=stream_vectors, options=None):
