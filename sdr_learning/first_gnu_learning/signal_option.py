...
class signal_option(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "signal_option")
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(16000, 32000, 1, 32000, 200)
...
def main(top_block_cls=signal_option, options=None):
