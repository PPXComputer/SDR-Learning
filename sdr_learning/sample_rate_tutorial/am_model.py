...
class am_model(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "am_trainsmitter")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("am_trainsmitter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "am_model")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 48e3, 0.5, 0, 0)
...
def main(top_block_cls=am_model, options=None):
